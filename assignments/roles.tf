...
resource azurerm_role_assignment "rem_role_mg" {
    ...
    scope = azurerm_management_group_policy_assignment.this[each.value[1]].management_group_id
...
resource azurerm_role_assignment "rem_role_subscription" {
    ...
    scope = azurerm_subscription_policy_assignment.this[each.value[1]].subscription_id
    role_definition_id = each.value[0]
...
resource azurerm_role_assignment "rem_role_rg" {
    ...
    scope = azurerm_resource_group_policy_assignment.this[each.value[1]].resource_group_id
    role_definition_id = each.value[0]
...
resource azurerm_role_assignment "rem_role_resource" {
    ...
    scope = azurerm_resource_policy_assignment.this[each.value[1]].resource_id
    role_definition_id = each.value[0]
